...
CREATE TABLE `action` (
                          `id` bigint NOT NULL AUTO_INCREMENT,
                          `actionname` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                          PRIMARY KEY (`id`)
...
CREATE TABLE `comment` (
                           `id` bigint NOT NULL AUTO_INCREMENT,
                           `content` varchar(21000) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `image_and_file` VALUES (1,1,2,2,NULL,NULL),(2,1,2,2,'acv',NULL),(3,1,2,2,'cc',NULL);
...
CREATE TABLE `notification` (
                                ...
                                `detail` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `project` (
                           `id` bigint NOT NULL AUTO_INCREMENT,
                           `project_name` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                           `start_date` date DEFAULT NULL,
                           `closure_date` date DEFAULT NULL,
                           `ended_date` date DEFAULT NULL,
                           `creator` bigint DEFAULT NULL,
                           `type` bigint DEFAULT NULL,
                           `customer_name` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
                           `customer_address` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
                           `customer_phone` varchar(45) DEFAULT NULL,
                           `construction_area` bigint DEFAULT NULL,
                           `detail` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                           `status` int DEFAULT NULL,
                           PRIMARY KEY (`id`),
                           UNIQUE KEY `id_UNIQUE` (`id`),
...
CREATE TABLE `requirement` (
                               `id` bigint NOT NULL AUTO_INCREMENT,
                               `project_id` bigint DEFAULT NULL,
                               `requirement_name` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                               `requirement_detail` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `section` (
                           `id` bigint NOT NULL AUTO_INCREMENT,
                           `section_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
                           `description` varchar(20000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
                           `project_id` bigint DEFAULT NULL,
                           `creator` bigint DEFAULT NULL,
                           PRIMARY KEY (`id`),
                           UNIQUE KEY `id_UNIQUE` (`id`),
...
INSERT INTO `section` VALUES (1,'Thiết kế bản vẽ',NULL,1,1),(2,'Lên hình ảnh 3D',NULL,1,1),(3,'demo123','aaa',2,6),(4,'cccc','aa',1,6),(5,'aa',NULL,1,1),(6,'dem1',NULL,1,1),(7,'dem2',NULL,1,1);
...
CREATE TABLE `status` (
                          ...
                          `status_account` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                          `status_project` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                          `status_requirement` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                          `status_task` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                          PRIMARY KEY (`id`),
                          UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task` (
                        ...
                        `task_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2022-11-20 18:56:11
