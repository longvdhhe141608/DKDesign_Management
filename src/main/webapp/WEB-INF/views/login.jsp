...
<div class="container">
    <div class="card card-container">
        ...
        <form id="addProject" class="form-signin" action="login" method="post">
            ...
            <input type="text" id="inputEmail" name="username" class="info-text form-control"
                   placeholder="Tên đăng nhập"
                   required="" autofocus="">
            <div class="text-danger error"></div>
            <input type="password" id="inputPassword" name="password" class="info-text form-control"
                   placeholder="Mật khẩu"
                   required="">
            <div class="text-danger error"></div>

            <button onclick="return checkvalidate('#addProject')"
                    class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Đăng nhập
            </button>
        </form>
        <!-- end form -->
